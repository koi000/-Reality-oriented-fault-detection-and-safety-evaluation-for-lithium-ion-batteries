# -*- coding: utf-8 -*-
"""
Created on Fri Apr 12 14:54:24 2024
...
for i in range(cell_volt.shape[1]):
    ...
    if i==1:
        plt.plot(tmp, color='#F08080',linewidth=2, label='Faulty cell 2',alpha=0.8)
    if i==48:
        plt.plot(tmp, color='#FF0000',linewidth=2, label='Faulty cell 49',alpha=0.8)
plt.axvline(warn_loc[0][1],color='#FF8C00',linewidth=4,alpha=0.6,linestyle='-.',label='BMS alarm')
